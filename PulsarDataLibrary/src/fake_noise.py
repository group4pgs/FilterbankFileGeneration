...
###########################################################################
# 2. Help function -- how to set the variables in the arguments list.
###########################################################################
def fakenoise_info():
    print(
    "\nfake_noise [options] > output.fil\n"\
    "\n"\
...
if __name__ == '__main__':
    ...
    parser.add_argument("-i", "--info", help="Information regarding the function",
                    action="store_true")
